...
namespace Nop.Services.NhaXes
{
    public partial interface ILimousineBanVeService
    {
        ...
        List<DatVe> GetSoLanDiTrongThang(int KhachHangId, DateTime NgayDi);
        ...
        List<XeDiTrongNgay> GetAllChuyenTheoXeTheoNgay(DateTime TuNgay,DateTime DenNgay, string SerchName, int NhaXeId);
